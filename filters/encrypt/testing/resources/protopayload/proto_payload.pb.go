...
var file_proto_payload_proto_goTypes = []interface{}{
...
func file_proto_payload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_payload_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WithTaggable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_payload_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EmbeddedTaggable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
